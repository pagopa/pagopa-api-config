...
cursor.execute("ALTER TABLE NODO4_CFG.IBAN_ATTRIBUTES_MASTER DROP CONSTRAINT FK_IBAN_ATTRIBUTES_MASTER_TO_IBAN_ATTRIBUTES")
cursor.execute("ALTER TABLE NODO4_CFG.IBAN_ATTRIBUTES_MASTER DROP CONSTRAINT FK_IBAN_ATTRIBUTES_MASTER_TO_IBAN_MASTER")
cursor.execute("ALTER TABLE NODO4_CFG.IBAN_MASTER DROP CONSTRAINT FK_IBAN_MASTER_TO_IBAN")
