...
#ENTRYPOINT ["java","-javaagent:opentelemetry-javaagent.jar","-javaagent:/applicationinsights-agent.jar","--enable-preview","org.springframework.boot.loader.JarLauncher"]
