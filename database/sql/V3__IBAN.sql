...
INSERT INTO NODO4_CFG.CODIFICHE (OBJ_ID, ID_CODIFICA, DESCRIZIONE) VALUES (1, 'BARCODE-GS1-128', 'Codifica barcode GS1-128 tot 13');
INSERT INTO NODO4_CFG.CODIFICHE (OBJ_ID, ID_CODIFICA, DESCRIZIONE) VALUES (2, 'QR-CODE', 'QR-CODE CF  11 caratteri');
INSERT INTO NODO4_CFG.CODIFICHE (OBJ_ID, ID_CODIFICA, DESCRIZIONE) VALUES (3, 'BARCODE-128-AIM', 'BARCODE-128-AIM zeri + ccp tot 12');


INSERT INTO NODO4_CFG.CODIFICHE_PA (OBJ_ID, CODICE_PA, FK_CODIFICA, FK_PA) VALUES (219, '00168480242', 2, 190);
INSERT INTO NODO4_CFG.CODIFICHE_PA (OBJ_ID, CODICE_PA, FK_CODIFICA, FK_PA) VALUES (220, '8088888169189', 1, 190);
...
INSERT INTO NODO4_CFG.INFORMATIVE_CONTO_ACCREDITO_MASTER (OBJ_ID, DATA_INIZIO_VALIDITA, DATA_PUBBLICAZIONE, ID_INFORMATIVA_CONTO_ACCREDITO_PA, RAGIONE_SOCIALE, FK_PA, FK_BINARY_FILE, VERSIONE) VALUES (228, TO_TIMESTAMP('2017-03-09 00:00:00.000000', 'YYYY-MM-DD HH24:MI:SS.FF6'), TO_TIMESTAMP('2017-03-08 00:00:00.000000', 'YYYY-MM-DD HH24:MI:SS.FF6'), 'C_A703-IBAN-20170308000000', 'Comune di Bassano del Grappa', 190, 201, null);
INSERT INTO NODO4_CFG.INFORMATIVE_CONTO_ACCREDITO_DETAIL (OBJ_ID, IBAN_ACCREDITO, FK_INFORMATIVA_CONTO_ACCREDITO_MASTER, ID_MERCHANT, CHIAVE_AVVIO, CHIAVE_ESITO, ID_BANCA_SELLER) VALUES (521, 'IT50M0200860165000003497481', 228, null, null, null, null);
