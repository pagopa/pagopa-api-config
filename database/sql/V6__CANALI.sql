...
INSERT INTO NODO4_CFG.CANALI (OBJ_ID, ID_CANALE, ENABLED, IP, PASSWORD, PORTA, PROTOCOLLO, SERVIZIO, DESCRIZIONE, FK_INTERMEDIARIO_PSP, PROXY_ENABLED, PROXY_HOST, PROXY_PASSWORD, PROXY_PORT, PROXY_USERNAME, CANALE_NODO, CANALE_AVV, FK_CANALI_NODO, TIMEOUT, NUM_THREAD, USE_NEW_FAULT_CODE, TIMEOUT_A, TIMEOUT_B, TIMEOUT_C, SERVIZIO_NMP) VALUES (1, '00001060966_01', 'Y', '1.1.1.1', 'FakePay', 443, 'HTTPS', 'basepath/services/fake', null, 6, 'Y', '2.2.2.2', null, 8080, null, 'Y', 'N', 1, 120, 2, 'Y', 15, 30, 120, null);
