...
class MassiveLoadingServiceEserTest {
  ...
  void massiveMigration() throws IOException {
    when(stazioniRepository.findByIdStazione(anyString()))
        .thenReturn(Optional.of(getMockStazioni()));
    when(paRepository.findByIdDominio(anyString())).thenReturn(Optional.of(getMockPa()));
    when(paStazionePaRepository.findAllByFkPaAndFkStazione_ObjId(anyLong(), any()))
        .thenReturn(Optional.of(getMockPaStazionePa()), Optional.empty());
    ...
    verify(paStazionePaRepository, times(1)).save(any(PaStazionePa.class));
  }
  ...
  void massiveMigrationBadRequest_1() throws IOException {
    ...
    verify(paStazionePaRepository, times(0)).save(any(PaStazionePa.class));
  }
  ...
  void massiveMigrationBadRequest_3() throws IOException {
    ...
    when(paRepository.findByIdDominio(anyString())).thenReturn(Optional.of(getMockPa()));
    when(paStazionePaRepository.findAllByFkPaAndFkStazione_ObjId(anyLong(), any()))
        .thenReturn(Optional.empty(), Optional.of(getMockPaStazionePa()));
    when(paStazionePaRepository.save(any(PaStazionePa.class))).thenReturn(getMockPaStazionePa());
  ...
  void massiveMigrationConflict_1() throws IOException {
    ...
    when(paStazionePaRepository.findAllByFkPaAndFkStazione_ObjId(anyLong(), any()))
        .thenReturn(Optional.of(mockPaStazione), Optional.of(mockPaStazione));
    when(paStazionePaRepository.save(any(PaStazionePa.class))).thenReturn(getMockPaStazionePa());
