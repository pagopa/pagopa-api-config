...
import static it.gov.pagopa.apiconfig.TestUtil.getMockConfigurationKeys;
import static it.gov.pagopa.apiconfig.TestUtil.getMockFtpServer;
import static it.gov.pagopa.apiconfig.TestUtil.getMockFtpServers;
...
import static it.gov.pagopa.apiconfig.TestUtil.getMockPaymentTypes;
import static it.gov.pagopa.apiconfig.TestUtil.getMockPdd;
import static it.gov.pagopa.apiconfig.TestUtil.getMockPdds;
import static it.gov.pagopa.apiconfig.TestUtil.getMockWfespPluginConfigurations;
...
import it.gov.pagopa.apiconfig.model.configuration.ConfigurationKeyBase;
import it.gov.pagopa.apiconfig.service.ConfigurationService;
...
class ConfigurationControllerTest {
  ...
  void setUp() {
    ...
    when(configurationService.getConfigurationKey("category", "key"))
        .thenReturn(getMockConfigurationKey("category", "key"));

    when(configurationService.getWfespPluginConfigurations())
        .thenReturn(getMockWfespPluginConfigurations());
    when(configurationService.getWfespPluginConfiguration("idServPlugin"))
        .thenReturn(getMockModelWfespPluginConf());
  ...
  void updateConfigurationKey() throws Exception {
    when(configurationService.updateConfigurationKey(
            anyString(), anyString(), any(ConfigurationKeyBase.class)))
        .thenReturn(getMockConfigurationKey("category", "key"));

    mvc.perform(
            put("/configuration/keys/category/category/key/key")
                .content(TestUtil.toJson(getMockConfigurationKey()))
                .contentType(MediaType.APPLICATION_JSON))
        .andExpect(status().isOk());
  }
  ...
  void deleteConfigurationKey() throws Exception {
    ...
    mvc.perform(
            delete("/configuration/keys/category/category/key/key")
                .contentType(MediaType.APPLICATION_JSON))
        .andExpect(status().isOk());
  }
  ...
  void createWfespPlugin() throws Exception {
    mvc.perform(
            post("/configuration/wfespplugins")
  ...
  void createWfespPlugin_400() throws Exception {
    mvc.perform(
            post("/configuration/wfespplugins")
                .content(
                    TestUtil.toJson(
                        getMockModelWfespPluginConf().toBuilder().idServPlugin("").build()))
                .contentType(MediaType.APPLICATION_JSON))
        .andExpect(status().is(HttpStatus.BAD_REQUEST.value()))
        .andExpect(content().contentType(MediaType.APPLICATION_JSON));
  }
  ...
  void updateWfespPlugin() throws Exception {
    mvc.perform(
            put("/configuration/wfespplugins/idServPlugin")
                .content(TestUtil.toJson(getMockModelWfespPluginConf()))
                .contentType(MediaType.APPLICATION_JSON))
        .andExpect(status().isOk());
  }
  ...
  void deleteWfespPlugin() throws Exception {
    mvc.perform(
            delete("/configuration/wfespplugins/idServPlugin")
                .contentType(MediaType.APPLICATION_JSON))
        .andExpect(status().isOk());
  }
  ...
  void createPdd_400() throws Exception {
    mvc.perform(
            post("/configuration/pdds")
                .content(TestUtil.toJson(getMockPdd().toBuilder().idPdd("").build()))
                .contentType(MediaType.APPLICATION_JSON))
        .andExpect(status().is(HttpStatus.BAD_REQUEST.value()))
        .andExpect(content().contentType(MediaType.APPLICATION_JSON));
  }
  ...
  void createFtpServer_400() throws Exception {
    mvc.perform(
            post("/configuration/ftpservers")
                .content(TestUtil.toJson(getMockFtpServer().toBuilder().host("").build()))
                .contentType(MediaType.APPLICATION_JSON))
        .andExpect(status().is(HttpStatus.BAD_REQUEST.value()))
        .andExpect(content().contentType(MediaType.APPLICATION_JSON));
  }
  ...
  void updateFtpServer() throws Exception {
    mvc.perform(
            put("/configuration/ftpservers/host/host/port/1/service/service")
                .content(TestUtil.toJson(getMockFtpServer()))
                .contentType(MediaType.APPLICATION_JSON))
        .andExpect(status().isOk());
  }
  ...
  void deleteFtpServer() throws Exception {
    mvc.perform(
            delete("/configuration/ftpservers/host/host/port/1/service/service")
                .contentType(MediaType.APPLICATION_JSON))
        .andExpect(status().isOk());
  }
  ...
  void createPaymentType() throws Exception {
    mvc.perform(
            post("/configuration/paymenttypes")
  ...
  void updatePaymentType() throws Exception {
    mvc.perform(
            put("/configuration/paymenttypes/ABCVDF")
                .content(TestUtil.toJson(getMockPaymentType()))
                .contentType(MediaType.APPLICATION_JSON))
        .andExpect(status().isOk());
  }
  ...
  void deletePaymentType() throws Exception {
    mvc.perform(
            delete("/configuration/paymenttypes/ABCVDF").contentType(MediaType.APPLICATION_JSON))
        .andExpect(status().isOk());
  }
  ...
  void getPaymentTypesHistory() throws Exception {
    mvc.perform(
            get("/configuration/paymenttypes/history")
                .content(TestUtil.toJson(getMockConfigurationKey())))
        .andExpect(status().isOk());
  }
}
