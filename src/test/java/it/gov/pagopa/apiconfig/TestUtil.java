...
import it.gov.pagopa.apiconfig.model.configuration.AfmMarketplacePaymentType;
import it.gov.pagopa.apiconfig.model.configuration.CacheVersions;
import it.gov.pagopa.apiconfig.model.configuration.ConfigurationKey;
import it.gov.pagopa.apiconfig.model.configuration.ConfigurationKeys;
import it.gov.pagopa.apiconfig.model.configuration.FtpServer;
import it.gov.pagopa.apiconfig.model.configuration.FtpServers;
import it.gov.pagopa.apiconfig.model.configuration.PaymentType;
import it.gov.pagopa.apiconfig.model.configuration.PaymentTypes;
import it.gov.pagopa.apiconfig.model.configuration.Pdd;
import it.gov.pagopa.apiconfig.model.configuration.Pdds;
import it.gov.pagopa.apiconfig.model.configuration.WfespPluginConfs;
import it.gov.pagopa.apiconfig.model.creditorinstitution.BrokerDetails;
import it.gov.pagopa.apiconfig.model.creditorinstitution.Brokers;
import it.gov.pagopa.apiconfig.model.creditorinstitution.CounterpartTable;
import it.gov.pagopa.apiconfig.model.creditorinstitution.CounterpartTables;
...
import it.gov.pagopa.apiconfig.model.creditorinstitution.CreditorInstitutionStationList;
import it.gov.pagopa.apiconfig.model.creditorinstitution.CreditorInstitutions;
...
import it.gov.pagopa.apiconfig.model.creditorinstitution.Ibans;
import it.gov.pagopa.apiconfig.model.creditorinstitution.Ica;
import it.gov.pagopa.apiconfig.model.creditorinstitution.Icas;
...
import it.gov.pagopa.apiconfig.model.creditorinstitution.Stations;
import it.gov.pagopa.apiconfig.model.creditorinstitution.XSDValidation;
import it.gov.pagopa.apiconfig.model.filterandorder.Filter;
...
import it.gov.pagopa.apiconfig.model.filterandorder.OrderType;
import it.gov.pagopa.apiconfig.model.psp.BrokerPspDetails;
import it.gov.pagopa.apiconfig.model.psp.BrokersPsp;
import it.gov.pagopa.apiconfig.model.psp.Cdi;
import it.gov.pagopa.apiconfig.model.psp.Cdis;
import it.gov.pagopa.apiconfig.model.psp.ChannelDetails;
import it.gov.pagopa.apiconfig.model.psp.ChannelPsp;
...
public class TestUtil {
  ...
  public static it.gov.pagopa.apiconfig.model.configuration.WfespPluginConf
      getMockModelWfespPluginConf() {
    return it.gov.pagopa.apiconfig.model.configuration.WfespPluginConf.builder()
        .idServPlugin("idServPlugin")
        .idBean("sdf")
        .build();
  }
