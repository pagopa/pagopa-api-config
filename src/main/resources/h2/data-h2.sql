...
INSERT INTO NODO4_CFG.INTERMEDIARI_PSP (OBJ_ID, ID_INTERMEDIARIO_PSP, ENABLED, CODICE_INTERMEDIARIO, INTERMEDIARIO_AVV, INTERMEDIARIO_NODO, FAULT_BEAN_ESTESO)
VALUES (6, '17103880000', 'Y', 'Postecom', 'N', 'Y', 'N');

INSERT INTO NODO4_CFG.PSP (OBJ_ID, ID_PSP, ENABLED, ABI, BIC, DESCRIZIONE, RAGIONE_SOCIALE, FK_INT_QUADRATURE, STORNO_PAGAMENTO, FLAG_REPO_COMMISSIONE_CARICO_PA, EMAIL_REPO_COMMISSIONE_CARICO_PA, CODICE_MYBANK, MARCA_BOLLO_DIGITALE, AGID_PSP, PSP_NODO, PSP_AVV, CODICE_FISCALE, VAT_NUMBER)
VALUES (1, 'BPPIITRRZZZ', 'Y', '01600', 'BPPIITRRZZZ', 'Poste Italiane', 'Poste Italiane', 6, 0, 'N', null, null, 0, 'N', 'Y', 'N', '17103880000', null);
