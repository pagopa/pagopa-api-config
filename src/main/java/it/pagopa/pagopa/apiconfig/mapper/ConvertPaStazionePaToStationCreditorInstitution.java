...
public class ConvertPaStazionePaToStationCreditorInstitution implements Converter<PaStazionePa, StationCreditorInstitution> {

    @Override
    public StationCreditorInstitution convert(MappingContext<PaStazionePa, StationCreditorInstitution> context) {
