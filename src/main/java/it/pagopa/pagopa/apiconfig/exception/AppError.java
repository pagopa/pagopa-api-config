...
public enum AppError {
    ...
    RELATION_STATION_NOT_CONFLICT(HttpStatus.CONFLICT, "Relation Station-CI conflict", "Relation Station-CI between Station with code %s and Creditor Institution with code %s already exists"),
