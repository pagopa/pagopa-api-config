...
public class BrokerPspController {
  ...
  @Operation(summary = "Get paginated list of PSP brokers", security = {
  ...
  @Operation(summary = "Get PSP broker details", security = {@SecurityRequirement(name = "ApiKey"),
  ...
  public ResponseEntity<BrokerPspDetails> getBrokerPsp(
      @NotBlank @Size(max = 50) @Parameter(description = "Broker code of a PSP.", required = true) @PathVariable("brokerpspcode") String brokerPspCode) {
    return ResponseEntity.ok(brokersPspService.getBrokerPsp(brokerPspCode));
  }

  @Operation(summary = "Create a PSP broker", security = {@SecurityRequirement(name = "ApiKey"),
      @SecurityRequirement(name = "Authorization")}, tags = {"Payment Service Providers"})
  @ApiResponses(value = {
  ...
  @Operation(summary = "Update a broker PSP", security = {@SecurityRequirement(name = "ApiKey"),
      @SecurityRequirement(name = "Authorization")}, tags = {"Payment Service Providers"})
  @ApiResponses(value = {
      @ApiResponse(responseCode = "200", description = "OK", content = @Content(mediaType = MediaType.APPLICATION_JSON_VALUE, schema = @Schema(implementation = BrokerPspDetails.class))),
      @ApiResponse(responseCode = "400", description = "Bad Request", content = @Content(mediaType = MediaType.APPLICATION_JSON_VALUE, schema = @Schema(implementation = ProblemJson.class))),
  ...
  public ResponseEntity<BrokerPspDetails> updateBrokerPsp(
      @Size(max = 50) @Parameter(description = "broker PSP code", required = true) @PathVariable("brokerpspcode") String brokerPspCode,
  ...
  @Operation(summary = "Delete a broker PSP", security = {@SecurityRequirement(name = "ApiKey"),
      @SecurityRequirement(name = "Authorization")}, tags = {"Payment Service Providers"})
  @ApiResponses(value = {
  ...
  @Operation(summary = "Get the PSP list of a broker", security = {
      @SecurityRequirement(name = "ApiKey"), @SecurityRequirement(name = "Authorization")}, tags = {
      "Payment Service Providers",})
  @ApiResponses(value = {
