...
public class PspController {
    ...
    public ResponseEntity<PaymentServiceProviders> getPaymentServiceProviders(
            ...
            @RequestParam(required = false, name = "orderby", defaultValue = "CODE") @Parameter(description = "Order by code or name") Order.Psp orderBy,
    ...
    @Operation(summary = "Update a relation between PSP and channel", security = {@SecurityRequirement(name = "ApiKey"), @SecurityRequirement(name = "Authorization")}, tags = {"Payment Service Providers"})
    @ApiResponses(value = {
