...
import it.gov.pagopa.apiconfig.model.CheckItem;
import it.gov.pagopa.apiconfig.model.MassiveCheck;
...
import it.gov.pagopa.apiconfig.service.IcaService;
...
public class IcaController {
  ...
  @Autowired IcaService icaService;
        ...
        @ApiResponse(
            ...
            content =
                @Content(
                    ...
                    schema = @Schema(implementation = Icas.class))),
        @ApiResponse(
            responseCode = "400",
  ...
  public ResponseEntity<Icas> getIcas(
      ...
      @PositiveOrZero
          ...
          @RequestParam
          Integer page,
      @Parameter(description = "filter by Id ICA") @RequestParam(value = "idica", required = false)
          String idIca,
  ...
  public ResponseEntity<Resource> getIca(
      ...
      value = {
        @ApiResponse(
            ...
            content =
                @Content(
                    mediaType = MediaType.APPLICATION_JSON_VALUE,
                    schema = @Schema(implementation = XSDValidation.class))),
        @ApiResponse(
            responseCode = "400",
            description = "Bad Request",
            content =
  ...
  @PostMapping(
      ...
      produces = {MediaType.APPLICATION_JSON_VALUE})
  public ResponseEntity<XSDValidation> checkXSD(
      @NotNull
          @Parameter(
  ...
  @PostMapping(
      ...
      consumes = {MediaType.MULTIPART_FORM_DATA_VALUE},
      produces = {MediaType.APPLICATION_JSON_VALUE})
  public ResponseEntity<List<CheckItem>> verifyIca(
      @NotNull
          @Parameter(
              description = "XML file regarding ICA to check",
              required = true,
  ...
  @PostMapping(
      value = "",
      consumes = {MediaType.MULTIPART_FORM_DATA_VALUE})
  public ResponseEntity<Void> createIca(
      @NotNull
          @Parameter(
          ...
          @RequestParam("file")
          MultipartFile file,
      @Parameter(description = "Force upload ignoring the validity date")
      ...
      value = {
        @ApiResponse(
            ...
            content =
                @Content(
                    mediaType = MediaType.APPLICATION_JSON_VALUE,
                    array = @ArraySchema(schema = @Schema(implementation = MassiveCheck.class)))),
        @ApiResponse(
            responseCode = "400",
            description = "Bad Request",
            content =
