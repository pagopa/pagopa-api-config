...
import it.gov.pagopa.apiconfig.model.afm.PaymentTypesCosmos;
...
import it.gov.pagopa.apiconfig.model.configuration.PaymentTypeBase;
import it.gov.pagopa.apiconfig.model.configuration.PaymentTypes;
import it.gov.pagopa.apiconfig.model.configuration.Pdd;
import it.gov.pagopa.apiconfig.model.configuration.PddBase;
import it.gov.pagopa.apiconfig.model.configuration.Pdds;
import it.gov.pagopa.apiconfig.model.configuration.WfespPluginConf;
import it.gov.pagopa.apiconfig.model.configuration.WfespPluginConfBase;
...
import it.gov.pagopa.apiconfig.util.AFMMarketplaceClient;
...
public class ConfigurationService {
  ...
  public ConfigurationKeys getConfigurationKeys() {
    ...
    return it.gov.pagopa.apiconfig.model.configuration.ConfigurationKeys.builder()
  ...
  public WfespPluginConfs getWfespPluginConfigurations() {
    ...
    return it.gov.pagopa.apiconfig.model.configuration.WfespPluginConfs.builder()
  ...
  public Pdds getPdds() {
    ...
    return it.gov.pagopa.apiconfig.model.configuration.Pdds.builder()
  ...
  public FtpServers getFtpServers() {
    ...
    return it.gov.pagopa.apiconfig.model.configuration.FtpServers.builder()
  ...
  public PaymentTypes getPaymentTypes() {
    ...
    return it.gov.pagopa.apiconfig.model.configuration.PaymentTypes.builder()
   ...
   * @return a list of {@link it.gov.pagopa.apiconfig.model.configuration.ConfigurationKey}.
   */
   ...
   * @return a list of {@link it.gov.pagopa.apiconfig.model.configuration.WfespPluginConf}.
   */
   ...
   * @return a list of {@link it.gov.pagopa.apiconfig.model.configuration.Pdds}.
   */
   ...
   * @return a list of {@link it.gov.pagopa.apiconfig.model.configuration.FtpServer}.
   */
