...
import static it.gov.pagopa.apiconfig.util.CommonUtil.deNull;
...
import it.gov.pagopa.apiconfig.model.creditorinstitution.StationCreditorInstitutions;
...
public class StationsService {
  ...
  @Autowired StazioniRepository stazioniRepository;

  @Autowired PaStazionePaRepository paStazioniRepository;
  ...
  public byte[] getStationsCSV() {
    ...
    var csvRows = stations.stream().map(this::getCsvValuesWithUrl).collect(Collectors.toList());
    List<String> headers =
