...
import static it.gov.pagopa.apiconfig.util.CommonUtil.getExceptionErrors;
import static it.gov.pagopa.apiconfig.util.CommonUtil.mapXml;
import static it.gov.pagopa.apiconfig.util.CommonUtil.syntaxValidation;
...
import it.gov.pagopa.apiconfig.model.creditorinstitution.IcaXml;
...
public class IcaService {
  ...
  private List<MassiveCheck> massiveRead(
    ...
    try {
      ...
      throw new AppException(
          HttpStatus.BAD_REQUEST, ICA_BAD_REQUEST, "Problem when unzipping file");
    }
