...
import it.gov.pagopa.apiconfig.mapper.ConvertBrokerDetailsToIntermediariPa;
import it.gov.pagopa.apiconfig.mapper.ConvertBrokerPspDetailsToIntermediariPsp;
import it.gov.pagopa.apiconfig.mapper.ConvertCanaleTipoVersamentoToPaymentType;
import it.gov.pagopa.apiconfig.mapper.ConvertCanaliToChannel;
import it.gov.pagopa.apiconfig.mapper.ConvertCanaliToChannelDetails;
import it.gov.pagopa.apiconfig.mapper.ConvertCdiMasterToCdi;
import it.gov.pagopa.apiconfig.mapper.ConvertChannelDetailsToCanali;
import it.gov.pagopa.apiconfig.mapper.ConvertCodifichePaToEncoding;
import it.gov.pagopa.apiconfig.mapper.ConvertConfigurationKeysToConfigurationKey;
import it.gov.pagopa.apiconfig.mapper.ConvertCreditorInstitutionDetailsToPa;
import it.gov.pagopa.apiconfig.mapper.ConvertCreditorInstitutionStationPostToPaStazionePa;
import it.gov.pagopa.apiconfig.mapper.ConvertElencoServiziToService;
import it.gov.pagopa.apiconfig.mapper.ConvertEncodingToCodifichePa;
import it.gov.pagopa.apiconfig.mapper.ConvertFtpServersToFtpServer;
import it.gov.pagopa.apiconfig.mapper.ConvertIbanValidiPerPaToIban;
import it.gov.pagopa.apiconfig.mapper.ConvertInformativeContoAccreditoMasterRepositoryToIca;
import it.gov.pagopa.apiconfig.mapper.ConvertInformativePaMasterToCounterpartTable;
import it.gov.pagopa.apiconfig.mapper.ConvertIntermediariPaToBroker;
import it.gov.pagopa.apiconfig.mapper.ConvertIntermediariPaToBrokerDetails;
import it.gov.pagopa.apiconfig.mapper.ConvertIntermediariPspToBrokerPsp;
import it.gov.pagopa.apiconfig.mapper.ConvertIntermediariPspToBrokerPspDetails;
import it.gov.pagopa.apiconfig.mapper.ConvertPaStazionePaToCreditorInstitutionStation;
import it.gov.pagopa.apiconfig.mapper.ConvertPaStazionePaToStationCreditorInstitution;
import it.gov.pagopa.apiconfig.mapper.ConvertPaToCreditorInstitution;
import it.gov.pagopa.apiconfig.mapper.ConvertPaToCreditorInstitutionDetails;
import it.gov.pagopa.apiconfig.mapper.ConvertPaymentServiceProviderDetailsToPsp;
import it.gov.pagopa.apiconfig.mapper.ConvertPaymentTypeToString;
import it.gov.pagopa.apiconfig.mapper.ConvertPaymentTypeToTipiVersamento;
import it.gov.pagopa.apiconfig.mapper.ConvertPddEToPddM;
import it.gov.pagopa.apiconfig.mapper.ConvertPddMToPddE;
import it.gov.pagopa.apiconfig.mapper.ConvertPspCanaleTipoVersamentoToPaymentServiceProviderView;
...
import it.gov.pagopa.apiconfig.mapper.ConvertTipiVersamentoToPaymentType;
import it.gov.pagopa.apiconfig.mapper.ConvertWfespPluginConfToWfespPluginConf;
import it.gov.pagopa.apiconfig.model.configuration.ConfigurationKey;
import it.gov.pagopa.apiconfig.model.configuration.FtpServer;
import it.gov.pagopa.apiconfig.model.configuration.PaymentType;
import it.gov.pagopa.apiconfig.model.creditorinstitution.Broker;
import it.gov.pagopa.apiconfig.model.creditorinstitution.BrokerDetails;
import it.gov.pagopa.apiconfig.model.creditorinstitution.CounterpartTable;
import it.gov.pagopa.apiconfig.model.creditorinstitution.CreditorInstitution;
import it.gov.pagopa.apiconfig.model.creditorinstitution.CreditorInstitutionDetails;
import it.gov.pagopa.apiconfig.model.creditorinstitution.CreditorInstitutionStation;
...
import it.gov.pagopa.apiconfig.model.creditorinstitution.Iban;
import it.gov.pagopa.apiconfig.model.creditorinstitution.Ica;
import it.gov.pagopa.apiconfig.model.creditorinstitution.Station;
import it.gov.pagopa.apiconfig.model.creditorinstitution.StationCreditorInstitution;
import it.gov.pagopa.apiconfig.model.creditorinstitution.StationDetails;
import it.gov.pagopa.apiconfig.model.psp.BrokerPsp;
import it.gov.pagopa.apiconfig.model.psp.BrokerPspDetails;
import it.gov.pagopa.apiconfig.model.psp.Cdi;
import it.gov.pagopa.apiconfig.model.psp.Channel;
...
public class MappingsConfiguration {
  ...
  ModelMapper modelMapper() {
    ...
    Converter<WfespPluginConf, it.gov.pagopa.apiconfig.model.configuration.WfespPluginConf>
        convertConfWfespPluginConf = new ConvertWfespPluginConfToWfespPluginConf();
    Converter<Pdd, it.gov.pagopa.apiconfig.model.configuration.Pdd> convertPddEToPddM =
        new ConvertPddEToPddM();
    Converter<it.gov.pagopa.apiconfig.model.configuration.Pdd, Pdd> convertPddMToPddE =
    ...
    mapper
        .createTypeMap(
            ...
            it.gov.pagopa.apiconfig.model.configuration.WfespPluginConf.class)
        .setConverter(convertConfWfespPluginConf);
    mapper
        .createTypeMap(Pdd.class, it.gov.pagopa.apiconfig.model.configuration.Pdd.class)
        .setConverter(convertPddEToPddM);
    mapper
        .createTypeMap(it.gov.pagopa.apiconfig.model.configuration.Pdd.class, Pdd.class)
