...
public class LoggingAspect {
  ...
  @Pointcut("execution(* it.gov.pagopa.apiconfig.mapper..*.*(..))")
  public void mapper() {
    // all mapper methods
  }

  @Pointcut("execution(* it.gov.pagopa.apiconfig.util..*.*(..))")
  public void util() {
    // all util methods
  }
  ...
  @AfterReturning(
      value = "execution(* it.gov.pagopa.apiconfig.exception.ErrorHandler.*(..))",
      returning = "result")
