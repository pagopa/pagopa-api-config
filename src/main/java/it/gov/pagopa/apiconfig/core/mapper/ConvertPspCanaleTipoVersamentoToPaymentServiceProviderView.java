...
public class ConvertPspCanaleTipoVersamentoToPaymentServiceProviderView
    implements Converter<PspCanaleTipoVersamento, PaymentServiceProviderView> {

  @Override
  public PaymentServiceProviderView convert(
      MappingContext<PspCanaleTipoVersamento, PaymentServiceProviderView> context) {
    ...
    return PaymentServiceProviderView.builder()
        ...
        .paymentMethod(
            source.getCanaleTipoVersamento().getCanale().getFkCanaliNodo().getModelloPagamento())
        .build();
  }
}
